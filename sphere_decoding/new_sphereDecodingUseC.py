...
def sphere_decoding_BER(H_hat, y_sequence, bits_sequence, maxL):
    ...
    numSymData = y_sequence.shape[1]
    numRxAnt = y_sequence.shape[0]
    # print(numSymData)
    # print([numRxAnt, numTxPort])

    y_sequence = [y_sequence[:,ii].reshape(numRxAnt,1) for ii in range(numSymData)]
